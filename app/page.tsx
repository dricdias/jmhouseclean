...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy reveal"><p className="eyebrow">{t.eyebrow}</p><h1>{t.title}</h1><p className="hero-intro">{t.intro}</p><div className="hero-actions"><a className="button button-dark" href="#contact">{t.primary} <span>↗</span></a><a className="text-link" href="#work">{t.secondary} <span>→</span></a></div><div className="hero-note"><span className="dot" /> Jeane Matos House Clean <span className="note-divider" /> Fairfield County, CT</div></div>
      <div className="hero-visual reveal reveal-delay"><img src="/generated/home-hero.png" alt="Warm, spotless kitchen and living room prepared for a new day" /><div className="hero-stamp">Care<br /><i>in every</i><br />corner.</div><div className="hero-photo-label">Editorial detail · Imagem de apoio</div></div></section>
